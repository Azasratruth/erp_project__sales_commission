...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::middleware(['role:payables_manager'])->group(function () {
        Route::get('/sales_commissions_execute', 'Commission_Execute_Controller@index');
        Route::get('/sales_commissions_execute/{plan_id}/{plan_executed}/{user_id}/{commission_id}/{commission_amount}/{approve}', 'Commission_Execute_Controller@store');
    });
